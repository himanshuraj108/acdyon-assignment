...
function DashboardMockup() {
  ...
  return (
    <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200/80 dark:border-gray-800 bg-white dark:bg-gray-900 w-full select-none max-w-full">
      {/* Chrome Top Bar */}
      <div className="flex items-center gap-2 sm:gap-3 px-3.5 py-2.5 bg-gray-50 dark:bg-gray-900/90 border-b border-gray-200/80 dark:border-gray-800">
        ...
        <div className="flex-1 min-w-0">
          <div className="bg-white dark:bg-gray-800 rounded-md px-2.5 py-1 flex items-center gap-1.5 border border-gray-200 dark:border-gray-700 max-w-[200px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[105px_1fr] md:grid-cols-[105px_1fr_125px] min-h-[280px]">
        ...
        <div className="hidden sm:block bg-gray-50/70 dark:bg-gray-900/60 border-r border-gray-200/80 dark:border-gray-800 p-2.5">
          ...
          {['Dashboard', 'My Courses', 'Mentors', 'Projects', 'Community'].map((item, i) => (
            <div
              key={item}
              className={`px-2 py-1.5 rounded-lg text-[10px] mb-0.5 cursor-pointer transition-colors font-outfit truncate ${
                i === 1
        ...
        {/* Center Main Course Track */}
        <div className="p-3.5 sm:p-4 overflow-hidden bg-white dark:bg-gray-900 font-outfit">
          ...
          <div className="bg-slate-900 rounded-xl h-20 sm:h-24 mb-3 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="relative flex items-center gap-2 px-3">
              ...
              <div className="min-w-0">
                <div className="text-white text-[10px] font-medium truncate">Neural Networks</div>
        ...
        <div className="hidden md:flex border-l border-gray-200/80 dark:border-gray-800 p-3 flex-col gap-2 bg-gray-50/50 dark:bg-gray-900/50 font-outfit">
          ...
          <div className="bg-blue-50/80 dark:bg-brand-950/60 rounded-xl p-2 border border-blue-100/50 dark:border-brand-900/40">
            <p className="text-[9.5px] text-blue-900 dark:text-brand-200 leading-relaxed">
              You are ahead of schedule. Let's go deeper on backpropagation.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-2 self-end w-full border border-gray-200/60 dark:border-gray-700/60 shadow-2xs">
            <p className="text-[9.5px] text-gray-700 dark:text-gray-200 leading-relaxed">
              Can you explain gradients?
            </p>
          </div>

          <div className="bg-blue-50/80 dark:bg-brand-950/60 rounded-xl p-2 flex items-center gap-1">
...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center bg-white dark:bg-gray-950 overflow-hidden bg-mesh" id="platform">
      <div
        className="absolute top-[-8%] right-[-5%] w-[350px] sm:w-[600px] h-[350px] sm:h-[600px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(59,130,246,0.08) 0%, transparent 70%)' }}
      />
      <div
        className="absolute bottom-[5%] left-[-5%] w-[280px] sm:w-[450px] h-[280px] sm:h-[450px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(99,102,241,0.06) 0%, transparent 70%)' }}
      />

      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 pt-24 pb-16 sm:pt-28 sm:pb-20 lg:pt-36 lg:pb-28">
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 xl:gap-16 items-center">
          <div>
            <motion.div {...fadeUp(0)}>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/60 border border-blue-200/70 dark:border-blue-900 text-blue-700 dark:text-blue-400 text-[11.5px] sm:text-[13px] font-semibold tracking-wide uppercase mb-5 sm:mb-6 font-outfit">
            ...
            <motion.p
              {...fadeUp(0.16)}
              className="font-poppins font-normal text-[15px] sm:text-[16.5px] leading-[1.7] text-gray-600 dark:text-gray-300 max-w-[520px] mb-8 sm:mb-9"
            >
            ...
            <motion.p
              {...fadeUp(0.28)}
              className="mt-6 sm:mt-8 text-[12.5px] sm:text-[13.5px] text-gray-500 dark:text-gray-400 font-poppins font-normal"
            >
          ...
          >
            <DashboardMockup />
            <div
              className="absolute -bottom-6 -right-6 -z-10 w-full h-full rounded-2xl hidden sm:block"
