...
export default function HowItWorks() {
  return (
    <section className="py-24 lg:py-32 bg-gray-50/60 section-divider" id="mentors">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <motion.h2
            ...
            className="font-heading font-black text-[38px] sm:text-[44px] text-gray-900 leading-tight mb-4"
          >
        ...
        <div className="relative">
          <div
            className="absolute top-[52px] left-[calc(16.66%+28px)] right-[calc(16.66%+28px)] h-px bg-gray-200 hidden lg:block"
            style={{
              backgroundImage:
              ...
              return (
                ...
                >
                  <div className="relative mb-6">
                    <div className="w-14 h-14 rounded-2xl bg-white border border-gray-200 shadow-card flex items-center justify-center">
                    ...
                    <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-brand-600 flex items-center justify-center">
                      <span className="font-heading font-black text-[9px] text-white">
                        {step.number}
                      </span>
                    </div>
                  </div>

                  <h3 className="font-heading font-bold text-[20px] text-gray-900 mb-3 leading-snug">
                    {step.title}
                  </h3>
